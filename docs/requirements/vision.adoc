...
|Barbetreiber|Eigentümer/Leiter der Bar|Auftraggeber / stellt Anforderungen an den Online Shop
|Kunden|Kunden die für Parties oder Geschenke bestellen|
|Banken|wickeln den Zahlungsverkehr ab|
|Angestellt||
|Gesetzgeber||Datenschutzgesetz / Jugendschutzgestz / TMG / Versandabsatzgestz
|Zahlungsdienstleister||Verantwortung unklar
|Versanddienstleister||Verantwortung unklar
|Serverbetreiber / Webdienstleister||
|===
