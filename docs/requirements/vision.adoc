...
|Aufraggeber|Führt eine Bar und möchte sein Geschäft durch einen online Cocktailshop erweitern|Administration der Webside | Kunden |Geben Bestellungen auf und bezahlen diese mit einer auswählbaren Methode||Banken|wickeln den Zahlungsverkehr ab||
|===
